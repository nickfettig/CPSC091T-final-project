...
class Simulator():
    ...
    def create_graph(self, shift, angle):
        ...
        def isValid(robot, obstacles):
            ...
            """
            For a point robot, just use inside_convex_polygon()...
        ...
        def minkowskiSum(P, Q_list):
            ...
            Q_list: List of obstacles represented by vertices 
            ...
            We will use the method described above with P and -Q for each Q in Q_list
            ...
            for Q in Q_list:
                ...
                # if polygons intersect, return False 
